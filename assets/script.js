...
pEl.textContent =
  "This is a quiz over basic coding facts, answering each question will gain you a point. You have until time runs out. Each incorrect answer will reduce your time remaining";
...
var questionObj = [
  {
    ...
    answerChoices: [
      "1. Constant - declares a variable that cannot be reassigned",
      "2.Constructor - creates a new instance of an object",
      "3. Concatenate - combines two strings into one",
      "4.Continue - skips the rest of the loop and jumps to the next iteration",
    ],
    correctAnswer: 0,
  },
  {
    question:
      "2. Which of the following tags is used to create an ordered list in HTML?",
  ...
  },
  {
    ...
    answerChoices: [
      "1. Sets the margin to zero",
      "2. Centers the element horizontally within its parent",
      "3. Adds extra spacing to the top and bottom of the element",
      "4. Aligns the element to the right side of its container",
    ],
    correctAnswer: 1,
  },
  {
  ...
  {
    question:
      "5. What is the correct way to link an external CSS file to an HTML document?",
    answerChoices: [
      '1. <style src="styles.css">',
      '2. <link rel="stylesheet" type="text/css" href="styles.css">',
      '3. <css href="styles.css">',
      '4. <script type="text/javascript" src="styles.css">',
    ],
    correctAnswer: 1,
  },
];
...
function cycleQuestion() {
  if (currentQuestions < questionObj.length) {
    ...
    for (
      var i = 0;
      i < questionObj[currentQuestions].answerChoices.length;
      i++
    ) {
      var answerChoiceBtn = document.createElement("button");
      answerChoiceBtn.textContent =
        questionObj[currentQuestions].answerChoices[i];
